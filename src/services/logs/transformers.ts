...
export const transformClassLog = (record: DbClassLog): TransformedClassLog => {
  try {
    ...
    return {
      ...
      studentPayment: (record['Student Payment']?.toLowerCase() || 'pending') as 'paid' | 'unpaid' | 'pending' | 'overdue',
      tutorPayment: (record['Tutor Payment']?.toLowerCase() || 'pending') as 'paid' | 'unpaid' | 'pending' | 'overdue',
...
export const transformCodeLog = (record: DbCodeLog): TransformedClassLog => {
  try {
    ...
    return {
      ...
      studentPayment: (record.student_payment?.toLowerCase() || 'pending') as 'paid' | 'unpaid' | 'pending' | 'overdue',
      tutorPayment: (record.tutor_payment?.toLowerCase() || 'pending') as 'paid' | 'unpaid' | 'pending' | 'overdue',
