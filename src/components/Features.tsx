...
import { BookOpen, Users, Award, Clock, CheckCircle, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  const features = [
    {
      ...
      details: "Our adaptive learning system analyzes your progress and adjusts the curriculum to match your pace and learning style."
    },
    {
      ...
      details: "All our tutors are certified educators with years of experience in their respective fields."
    },
    {
      ...
      details: "From basic mathematics to advanced physics, we cover all subjects with detailed study materials."
    },
    {
      ...
      details: "Get weekly progress reports and performance analytics to track your improvement."
    },
    {
      icon: <Users className="h-8 w-8 text-tutoring-teal" />,
      title: "1 on 1 Sessions",
      description: "Personalized one-on-one tutoring sessions focused entirely on your learning needs and pace.",
      details: "Schedule flexible sessions with dedicated tutors who provide undivided attention."
    },
    {
      icon: <Award className="h-8 w-8 text-tutoring-teal" />,
      title: "College Prep",
      description: "Specialized programs for college admissions and standardized tests.",
      details: "Comprehensive preparation for SAT, ACT, and other college entrance exams."
    }
  ];
          ...
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-1/2 bg-tutoring-blue p-10 text-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {["Mathematics", "English", "Foreign Languages", "Computer Science", "Science", "History", "Test Prep", "Writing"].map((subject, idx) => (
