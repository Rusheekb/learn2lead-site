    ...
    try {
      if (role === 'student') {
        const { data, error } = await supabase
          .from('students')
          .select(
            'learning_pace, teaching_style_pref, session_structure_pref, primary_goal, availability_windows, communication_pref'
          )
          .eq('email', userEmail)
          .single();
        ...
        if (data && !error) {
          setStudentPrefs({
            ...
            session_structure_pref:
              (data.session_structure_pref as string) || '',
        ...
        const { data, error } = await supabase
          .from('tutors')
          .select(
            'teaching_style_strength, preferred_pace, pace_flexibility, session_structure, specialty_focus, availability_windows, grade_level_comfort'
          )
          .eq('email', userEmail)
          .single();
        ...
        if (data && !error) {
          setTutorPrefs({
            teaching_style_strength:
              (data.teaching_style_strength as string) || '',
            ...
            <div className="flex-1 min-w-0">
              ...
              {completeness < 100 && (
                <p className="text-xs text-muted-foreground mt-1">
                  Complete your preferences to help us find the best{' '}
                  {role === 'student' ? 'tutor' : 'student'} matches
                </p>
              )}
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            {role === 'student' ? 'tutor' : 'students'} by sharing your
            preferences.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {role === 'student' ? (
            <>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(v) =>
                    setStudentPrefs((p) => ({ ...p, learning_pace: v }))
                  }
                ...
                >
                  ...
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    ...
                    <Label htmlFor="pace-moderate" className="cursor-pointer">
                      Moderate
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="fast" id="pace-fast" />
                    <Label htmlFor="pace-fast" className="cursor-pointer">
                      Fast-paced
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(v) =>
                    setStudentPrefs((p) => ({ ...p, teaching_style_pref: v }))
                  }
                  className="grid grid-cols-1 sm:grid-cols-2 gap-2"
                >
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="visual" id="style-visual" />
                    <Label htmlFor="style-visual" className="cursor-pointer">
                      Visual (diagrams, charts)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="verbal" id="style-verbal" />
                    <Label htmlFor="style-verbal" className="cursor-pointer">
                      Verbal (explanations, discussion)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="hands_on" id="style-hands" />
                    <Label htmlFor="style-hands" className="cursor-pointer">
                      Hands-on (practice problems)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="mixed" id="style-mixed" />
                    <Label htmlFor="style-mixed" className="cursor-pointer">
                      Mixed approach
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-3">
                <Label className="text-base font-medium">
                  What session structure do you prefer?
                </Label>
                <RadioGroup
                ...
                >
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    ...
                    <Label
                      htmlFor="struct-structured"
                      className="cursor-pointer"
                    >
                      Structured (planned agenda)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="flexible" id="struct-flexible" />
                    <Label htmlFor="struct-flexible" className="cursor-pointer">
                      Flexible (go with the flow)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="mixed" id="struct-mixed" />
                    <Label htmlFor="struct-mixed" className="cursor-pointer">
                      Mixed
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(v) =>
                    setStudentPrefs((p) => ({ ...p, primary_goal: v }))
                  }
                  className="grid grid-cols-1 sm:grid-cols-2 gap-2"
                >
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="catch_up" id="goal-catch" />
                    <Label htmlFor="goal-catch" className="cursor-pointer">
                      Catch up / improve grades
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="maintain" id="goal-maintain" />
                    <Label htmlFor="goal-maintain" className="cursor-pointer">
                      Maintain current level
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="get_ahead" id="goal-ahead" />
                    <Label htmlFor="goal-ahead" className="cursor-pointer">
                      Get ahead / enrichment
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="test_prep" id="goal-test" />
                    <Label htmlFor="goal-test" className="cursor-pointer">
                      Test preparation
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(v) =>
                    setStudentPrefs((p) => ({ ...p, communication_pref: v }))
                  }
                  className="grid grid-cols-1 sm:grid-cols-3 gap-2"
                >
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                  ...
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    ...
                    <Label htmlFor="comm-direct" className="cursor-pointer">
                      Direct & to-the-point
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="balanced" id="comm-balanced" />
                    <Label htmlFor="comm-balanced" className="cursor-pointer">
                      Balanced
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-3">
                ...
                {/* grid-flow-col + grid-rows-3 fills column-first: since
                    AVAILABILITY_OPTIONS is ordered [3 weekday, 3 weekend],
                    this puts all weekday slots in the left column and all
                    weekend slots in the right column, instead of the default
                    row-first fill which mismatches them mid-list. */}
                <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-3 sm:grid-flow-col gap-2">
                  {AVAILABILITY_OPTIONS.map((option) => (
                    ...
                    >
                      <Checkbox
                        ...
                        checked={studentPrefs.availability_windows.includes(
                          option.value
                        )}
                        onCheckedChange={() =>
                          toggleArrayItem(
            ...
            <>
              ...
              <div className="space-y-3">
                <Label className="text-base font-medium">
                  What's your primary teaching style?
                </Label>
                <RadioGroup
                  value={tutorPrefs.teaching_style_strength}
                  onValueChange={(v) =>
                    setTutorPrefs((p) => ({ ...p, teaching_style_strength: v }))
                  }
                  className="grid grid-cols-1 sm:grid-cols-2 gap-2"
                >
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="visual" id="t-style-visual" />
                    <Label htmlFor="t-style-visual" className="cursor-pointer">
                      Visual (diagrams, charts)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="verbal" id="t-style-verbal" />
                    <Label htmlFor="t-style-verbal" className="cursor-pointer">
                      Verbal (explanations, discussion)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="hands_on" id="t-style-hands" />
                    <Label htmlFor="t-style-hands" className="cursor-pointer">
                      Hands-on (practice problems)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="mixed" id="t-style-mixed" />
                    <Label htmlFor="t-style-mixed" className="cursor-pointer">
                      Mixed / adaptable
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-3">
                <Label className="text-base font-medium">
                  What pace do you prefer teaching at?
                </Label>
                <RadioGroup
                  value={tutorPrefs.preferred_pace}
                  onValueChange={(v) =>
                    setTutorPrefs((p) => ({ ...p, preferred_pace: v }))
                  }
                  className="grid grid-cols-1 sm:grid-cols-3 gap-2"
                >
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="slow" id="t-pace-slow" />
                    <Label htmlFor="t-pace-slow" className="cursor-pointer">
                      Slow & thorough
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="moderate" id="t-pace-moderate" />
                    <Label htmlFor="t-pace-moderate" className="cursor-pointer">
                      Moderate
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="fast" id="t-pace-fast" />
                    <Label htmlFor="t-pace-fast" className="cursor-pointer">
                      Fast-paced
                    </Label>
                  </div>
                </RadioGroup>
                <div className="flex items-center space-x-2 mt-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setTutorPrefs((p) => ({
                        ...p,
                        pace_flexibility: checked as boolean,
                      }))
                    }
                  />
                  <Label htmlFor="pace-flexible" className="cursor-pointer">
                    I can adapt my pace to student needs
                  </Label>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(v) =>
                    setTutorPrefs((p) => ({ ...p, session_structure: v }))
                  }
                  className="grid grid-cols-1 sm:grid-cols-3 gap-2"
                >
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem
                      value="structured"
                      id="t-struct-structured"
                    />
                    <Label
                      htmlFor="t-struct-structured"
                      className="cursor-pointer"
                    >
                      Structured (planned agenda)
                    </Label>
                  ...
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    ...
                    <Label htmlFor="t-struct-mixed" className="cursor-pointer">
                      Mixed / adaptable
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(v) =>
                    setTutorPrefs((p) => ({ ...p, specialty_focus: v }))
                  }
                  className="grid grid-cols-1 sm:grid-cols-2 gap-2"
                >
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="struggling" id="spec-struggling" />
                    <Label htmlFor="spec-struggling" className="cursor-pointer">
                  ...
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    ...
                    <Label
                      htmlFor="spec-maintaining"
                      className="cursor-pointer"
                    >
                      Students maintaining grades
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="advanced" id="spec-advanced" />
                    <Label htmlFor="spec-advanced" className="cursor-pointer">
                      Advanced / gifted students
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border rounded-lg p-3">
                    <RadioGroupItem value="all" id="spec-all" />
                    <Label htmlFor="spec-all" className="cursor-pointer">
                      All student levels
                    </Label>
                  </div>
                </RadioGroup>
                  ...
                  {GRADE_LEVEL_OPTIONS.map((option) => (
                    ...
                    >
                      <Checkbox
                        ...
                        checked={tutorPrefs.grade_level_comfort.includes(
                          option.value
                        )}
                        onCheckedChange={() =>
                          toggleArrayItem(
                  ...
                  {AVAILABILITY_OPTIONS.map((option) => (
                    ...
                    >
                      <Checkbox
                        ...
                        checked={tutorPrefs.availability_windows.includes(
                          option.value
                        )}
                        onCheckedChange={() =>
                          toggleArrayItem(
