...
export const ClassCalendarContainer: React.FC<ClassCalendarContainerProps> =
  memo(({ studentId, onSelectClass }) => {
    const [selectedDate, setSelectedDate] = useState<Date>(new Date());
    const [selectedClass, setSelectedClass] = useState<ClassSession | null>(
      null
    );
