...
export const mockStudents: Student[] = [
  {
    ...
    progress:
      'Making good progress in Algebra. Needs more work on Calculus integrals.',
  },
  {
    id: '2',
    name: 'Jamie Smith',
    ...
    progress:
      'Excellent understanding of molecular biology. Working on chemistry formulas.',
  },
  {
    id: '3',
    name: 'Taylor Brown',
    ...
    progress:
      'Essay structure has improved. Currently working on thesis development.',
  },
  {
    id: '4',
    name: 'Morgan Lee',
    ...
    progress:
      'Conversational Spanish is improving. Need to focus on verb conjugations.',
  },
];
...
export const mockMessages: StudentMessageCollection[] = [
  {
    ...
    messages: [
      ...
      },
      {
        id: '2',
        content:
          "Yes, please bring your textbook. We'll be working on chapter 4.",
    ...
    notes: [
      {
        ...
        content:
          'Initial assessment complete. Student shows strong aptitude for algebra but needs work on geometry concepts.',
        date: '2023-03-15',
      },
      {
        id: '2',
        ...
        content:
          'Reviewed chapter 3 homework. Most problems correct, but struggling with word problems.',
        date: '2023-03-22',
      },
      {
        id: '3',
        ...
        content:
          'Focused on test-taking strategies. Created study guide for upcoming exam.',
        date: '2023-04-05',
      },
    ],
  },
