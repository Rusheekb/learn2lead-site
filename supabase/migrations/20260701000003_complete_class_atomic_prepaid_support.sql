-- Update complete_class_atomic to automatically set student_payment_date when the
-- student has prepaid class credits (prepaid_class_count > 0). This prevents advance
-- Zelle payments from creating false "unpaid" entries in the admin payment summary.
